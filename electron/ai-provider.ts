...
const samDomainInstruction = 'SAM LAB means Software Asset Management. Work only on software inventory, applications, products, vendors, licenses, seats, subscriptions, entitlements, contracts, utilization, usage, spend, reclamation, compliance and renewals. Never select an unrelated business dataset because it has PII tags, and never present privacy masking, generic data quality or ML lineage as the SAM objective. PII metadata is only a handling guardrail. Every useful result must explain the software product, purchased, assigned and active seats when available, inactive or duplicate assignments, entitlement or renewal exposure, annual cost or savings, evidence gaps and the owner action. Never invent these metrics.'
