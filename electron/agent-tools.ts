...
const cardRoles: Record<ProposalCardKind, CardPlanningContract> = {
  ...
  source: {
    role: 'Resolve a software inventory, license, subscription, entitlement, contract, usage or renewal source.',
    activation: 'Use after a specific software asset evidence source has been selected.',
    completion: 'Product identity, source provenance, evidence window and aggregate schema are fresh and versioned.',
  },
  profile: {
    role: 'Keep compact software asset, seat, entitlement, utilization and cost evidence without raw user activity.',
    activation: 'Use when a SAM source or registered aggregate query produced evidence that downstream cards need to reuse.',
    completion: 'A host-verified aggregate snapshot records freshness, coverage and decision metrics.',
  },
  analysis: {
    role: 'Classify software assignment, utilization, entitlement, spend and renewal findings.',
    activation: 'Use when SAM evidence needs classification before optimization, compliance or renewal routing.',
    completion: 'Unused, underused, duplicate, unentitled, renewal, coverage or collection findings are bounded.',
  },
  impact: {
    role: 'Quantify affected seats, users, teams, contracts, annual spend and savings.',
    activation: 'Use when a SAM finding has fresh aggregate usage, contract or ownership evidence.',
    completion: 'The financial, operational and compliance impact is bounded and ranked.',
  },
  risk: {
    role: 'Classify license optimization, entitlement, compliance, renewal or collection risk from versioned evidence.',
    activation: 'Use after Analysis or Impact exposes a material SAM finding or evidence gap.',
    completion: 'Product scope, severity, confidence, evidence, affected seats or contracts and owner action are declared.',
  },
  patch: {
  ...
  transform: {
    role: 'Declare deterministic normalization of products, SKUs, contracts, entitlements, assignments or usage aggregates.',
    activation: 'Use when evidence identities or units must be normalized before a SAM decision.',
    completion: 'Inputs, outputs, invariants and rollback behavior are ready for atomic validation without vendor mutation.',
  },
  review: {
